...
class SummaryDetailPage extends StatefulWidget {
	...
	static Route route() {
		return MaterialPageRoute<void>(
			builder: (_) => const SummaryDetailPage(),
		);
	}
				...
				actions: [
								PopupMenuButton<String>(
									...
									itemBuilder: (context) => [
										...
										const PopupMenuItem(value: 'excel', child: Text('Descargar Excel')),
									],
									onSelected: (value) {
										if (value == 'pdf') {
			...
			body: ListView(
				...
				children: [
					...
					SummaryItemGroupCard(
						...
						items: [
							SummaryItemEntry(label: 'San Lorenzo → Laboulaye', amount: 200000, navigable: true),
							SummaryItemEntry(label: 'Venado Tuerto → San Nicolás', amount: 200000, navigable: true),
							SummaryItemEntry(label: 'Corral de Bustos → Armstrong', amount: 400000, navigable: true),
						],
						onItemTap: (i) {},
					),
					...
					SummaryItemGroupCard(
						title: 'Adelantos',
						items: [
							SummaryItemEntry(label: 'Adelantos de administración', amount: -300000),
					...
					SummaryItemGroupCard(
						...
						items: [
							SummaryItemEntry(label: 'Ajuste Diciembre 2025', amount: -30000, navigable: true),
							SummaryItemEntry(label: 'Mínimo garantizado', amount: 200000, navigable: true),
						],
						onItemTap: (i) {},
					),
					...
					FilledButton.icon(
						...
						style: FilledButton.styleFrom(fixedSize: const Size(double.infinity, 48)),
					),
					...
					onPressed: () async {
						final confirmed = await showDialog<bool>(
							...
							builder: (context) => AlertDialog(
								...
								content: const Text('Estás seguro de que querés aprobar este resumen?'),
								actions: [
